...
// Ambil Sektor
$sSQL = "SELECT DISTINCT fam_NamaSek FROM family_fam ORDER BY fam_NamaSek";
$rsSektor = RunQuery($sSQL);
...
<table align="center">
	<tr>
		...
		<td class="TextColumn">
			...
			while ($aRow = mysql_fetch_array($rsSektor)) {
				extract($aRow);
			    if ($fam_NamaSek != '') {
					echo "<option value=\"Sek" . $fam_NamaSek . "\">Sektor " . $fam_NamaSek . "</option>";
				}
			}
			echo "</select>";
			?>
