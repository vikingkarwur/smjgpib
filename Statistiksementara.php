...
<div id="column1">
  ...
  <table width="68%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td align="center"><a href="SelectList.php?mode=family">Jumlah KK </a> : 
        <?php echo gettext($TotalKK); ?></td>
      <td><a href="SelectList.php?mode=PW"><strong>BPK Pelayanan Wanita</strong></a></td>
    </tr>
    <tr> 
      <td><div align="center">Golongan Darah : 
...
?>
<BR>-------------------------------------------------------------------------------<BR>
Untuk melihat Anggota jemaat yg berulang tahun selama seminggu, tekan tombol GENERATE
