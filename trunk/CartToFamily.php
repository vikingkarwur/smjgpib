...
// End Added
		...
		{
			$sSQL = "INSERT INTO family_fam (fam_Name, fam_Address1, fam_Kompleks1, fam_RTRW1, fam_Kelurahan1, fam_Address2, fam_Kompleks2, fam_RTRW2, fam_Kelurahan2, fam_City, fam_State, fam_Zip, fam_Country, fam_HomePhone, fam_WorkPhone, fam_CellPhone, fam_Email, fam_WeddingDate, fam_DateEntered, fam_EnteredBy) VALUES ('" . $sFamilyName . "','" . $sAddress1 . "','" . $sKompleks1 . "','" . $sRTRW1 . "','" . $sKelurahan1 . "','" . $sAddress2 . "','" . $sKompleks2 . "','" . $sRTRW2 . "','" . $sKelurahan2 . "','" . $sCity . "','" . $sState . "','" . $sZip . "','" . $sCountry . "','" . $sHomePhone . "','" . $sWorkPhone . "','" . $sCellPhone . "','" . $sEmail . "'," . $dWeddingDate . ",'" . date("YmdHis") . "'," . $_SESSION['iUserID'] . ")";
			RunQuery($sSQL);
...
// Added for GPIB ?>
	<tr>
		<td class="LabelColumn"><?php echo gettext("Kompleks1:"); ?></td>
		<td class="TextColumn"><input type="text" Name="Kompleks1" value="<?php echo $sKompleks1; ?>" size="50" maxlength="250"></td>
	</tr>

	<tr>
		<td class="LabelColumn"><?php echo gettext("RT-RW1:"); ?></td>
		<td class="TextColumn"><input type="text" Name="RTRW1" value="<?php echo $sRTRW1; ?>" size="50" maxlength="250"></td>
	</tr>

	<tr>
		<td class="LabelColumn"><?php echo gettext("Kelurahan1:"); ?></td>
		<td class="TextColumn"><input type="text" Name="Kelurahan1" value="<?php echo $sKelurahan1; ?>" size="50" maxlength="250"></td>
	</tr>
<?php
// End Added ?>
...
// Added for GPIB ?>
	<tr>
		...
		<td class="TextColumn"><input type="text" Name="Kompleks2" value="<?php echo $sKompleks2; ?>" size="50" maxlength="250"></td>
	</tr>

	<tr>
		<td class="LabelColumn"><?php echo gettext("RT-RW2:"); ?></td>
		<td class="TextColumn"><input type="text" Name="RTRW2" value="<?php echo $sRTRW2; ?>" size="50" maxlength="250"></td>
	</tr>

	<tr>
		<td class="LabelColumn"><?php echo gettext("Kelurahan2:"); ?></td>
		<td class="TextColumn"><input type="text" Name="Kelurahan2" value="<?php echo $sKelurahan2; ?>" size="50" maxlength="250"></td>
	</tr>
<?php
// End Added ?>
