...
if (isset($_POST["doBackup"]))
{
	...
	if ($bNoErrors)
	{
		$saveTo = "SQL/smjGPIB-Backup-" . date("Ymd-Gis") . ".sql";
		$backupCommand = "$smysqldump -u $sUSER --password=$sPASSWORD $sDATABASE > $saveTo";
...
<h3><?php echo gettext("This tool will assist you in manually backing up the smjGPIB database."); ?></h3>
<BR>
...
<li><?php echo gettext("If you are concerned about confidentiality of data stored in the smjGPIB database, you should encrypt the backup data if it will be stored somewhere potentially accessible to others"); ?></li><br>
